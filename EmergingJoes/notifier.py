...
<div style="max-width:640px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;border:1px solid #ddd;">
  <div style="background:#1a1a2e;color:#fff;padding:16px 24px;">
    <h1 style="margin:0;font-size:18px;">JOES Threat Intelligence Alert</h1>
  </div>
  <div style="padding:24px;">
    ...
    <p style="font-size:12px;color:#999;">This alert was generated by JOES Threat Intelligence.</p>
    <p style="font-size:11px;color:#b0b0b0;line-height:1.5;margin-top:8px;">Disclaimer: This summary was generated by JOES Threat Intelligence using large language models (LLMs). LLMs can make mistakes. Always verify important information against the original source.</p>
  </div>
</div>
</body>
</html>"""
...
def send_article_notification(title, article_url, raw_data):
    ...
    subject = f"JOES Threat Intelligence: {title}"
...
def send_report_email(report_type: str, identifier: str, llm_content: str,
    ...
    subject = f"[JOES Threat Intelligence Report] {report_type} — {identifier[:80]}"
    meta_rows = "".join(
...
<div style='max-width:680px;margin:0 auto;background:#fff;border-radius:8px;border:1px solid #ddd;'>
  <div style='background:#1a1a2e;color:#fff;padding:16px 24px;'>
    <h1 style='margin:0;font-size:18px;'>JOES Threat Intelligence — LLM Output Report</h1>
  </div>
  <div style='padding:24px;'>
    ...
    <p style='font-size:11px;color:#999;margin-top:20px;'>Auto-generated by JOES Threat Intelligence. LLM content was not editable by the user.</p>
  </div>
</div></body></html>"""
...
<div style="max-width:680px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;border:1px solid #ddd;">
  <div style="background:#1a1a2e;color:#fff;padding:16px 24px;">
    <h1 style="margin:0;font-size:18px;">JOES Threat Intelligence Daily Digest</h1>
    <p style="margin:6px 0 0;font-size:13px;opacity:0.8;">{_esc(period_label)} &mdash; {len(stories)} stor{"y" if len(stories) == 1 else "ies"}</p>
  </div>
  <div style="padding:24px;">
    {stories_html}
    <hr style="border:none;border-top:1px solid #eee;margin:24px 0;">
    <p style="font-size:12px;color:#999;">This digest was generated by JOES Threat Intelligence.</p>
    <p style="font-size:11px;color:#b0b0b0;line-height:1.5;margin-top:8px;">Disclaimer: This summary was generated by JOES Threat Intelligence using large language models (LLMs). LLMs can make mistakes. Always verify important information against the original source.</p>
  </div>
</div>
</body>
...
def send_digest_email(stories, period_label):
    ...
    subject = f"JOES Threat Intelligence Daily Digest \u2013 {period_label}"
    ok, err = _send_email(smtp_cfg, subject, html)
    if ok:
...
def send_test_email(smtp_cfg=None):
    ...
    dummy_data = {
        "executive_summary": (
            "This is a test notification from JOES Threat Intelligence. If you are reading this, "
    ...
    return _send_email(smtp_cfg, "JOES Threat Intelligence: Test Notification", html)
