<p align="center">
  <img src="static/img/icon.jpg" alt="JOES Threat Intelligence" width="80">
</p>

# JOES Threat Intelligence — JOES Threat Intelligence fork

AI-powered threat news analysis platform — aggregation, summarization, and forecasting — extended for **operational CTI**: customer-mapped emerging threats, vulnerability advisories (Scriba), analyst triage queues, and APT → MISP export.

> Monorepo install & handoff: see [`../INSTALL.md`](../INSTALL.md) and [`../AGENT_HANDOFF.md`](../AGENT_HANDOFF.md).

**[Documentation](docs/index.md)** (MkDocs sources under `docs/`)

## JOES Threat Intelligence additions

- **Customers** — footprint (country, business, affiliates, tech stack)
...
Provided **"AS-IS" without warranty of any kind**, express or implied. Summaries,
severity calls, and customer matches are LLM-assisted and must be verified against
the original vendor advisory before an advisory is distributed to a customer.

## License

BSD 3-Clause — see [`LICENSE`](LICENSE). The copyright notice in that file must be
retained in any redistribution, in source or binary form.
