...
JOES Threat Intelligence is a self-hosted threat intelligence platform that **automatically collects**, **summarizes**, and **categorizes** cybersecurity articles from dozens of sources — then lets you **search**, **explore**, and **forecast** threats using AI.
...
!!! info "Screenshot"
    _A screenshot or GIF of the JOES Threat Intelligence dashboard can be added here._
