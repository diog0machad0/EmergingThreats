...
JOES Threat Intelligence generates two distinct AI-powered analyses for each threat category: **Historical Trend Analysis** (quarterly and yearly retrospective) and **Forecast** (current trend + 3-6 month outlook). Both are accessible from any category or subcategory drill-down view.
